<template>
  <nav class="flex items-center justify-between px-8 py-3 border-b border-gray-200">
    ...
    <button @click="onToggleButtonClicked" class="flex items-center justify-center p-2 rounded-full bg-slate-100 lg:hidden"><span class="material-icons">menu</span></button>
    <div ref="linksParentRef" class="fixed top-0 bottom-0 left-0 z-50 hidden p-4 bg-white shadow-lg lg:block lg:relative lg:w-auto w-[350px] lg:p-0 lg:shadow-none">
